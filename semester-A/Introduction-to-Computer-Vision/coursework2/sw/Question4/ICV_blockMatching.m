function [block_new_pos] = ICV_blockMatching(block,blockPos, search_window_size,inputImage)
%UNTITLED3 Summary of this function goes here
%   Detailed explanation goes here
block_h_min = blockPos(1,1);
block_h_max = blockPos(1,2);
block_w_min = blockPos(2,1);
block_w_max = blockPos(2,2);
