...
public class SingleTreeNode
{
    ...
    public SingleTreeNode(MctsParams p, GameState gameState,Random rnd, int num_actions, Types.ACTIONS[] actions, StateHeuristic heuristic) {
        this(p, null, -1, rnd, num_actions, actions, 0, heuristic);
        this.rootState = gameState;
        this.rootStateHeuristic = heuristic;
    }
    ...
    {
        return rollerState.isTerminal() || depth >= params.rollout_depth;
    }
    ...
    public int mostValueAction() {
        ...
        for (int i=0; i<children.length; i++) {
            ...
            if(children[i] != null)
            {
                ...
                double childValue =  hvVal / (children[i].nVisits + params.epsilon);
